...
abstract class StringSealedEnum(
    val value: String,
    val name: String,
) : SealedEnum() {
    companion object {
        @JvmStatic
        fun <T : StringSealedEnum> all(javaClass: Class<T>): List<T> {
            return javaClass.kotlin.sealedSubclasses
                .map {
                    it.objectInstance as T
                }
        ...
        @JvmStatic
        fun <T : StringSealedEnum> valueOf(javaClass: Class<T>, value: String): T? {
            return all(javaClass)
                .firstOrNull {
                    it.value == value
                }
        ...
        inline fun <reified T : StringSealedEnum> valueOf(value: String): T? {
            return all<T>()
                .firstOrNull {
                    it.value == value
                }
